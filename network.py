...
def init_network():
    ...
    model = ks.Sequential()
    model.add(ks.layers.Dense(1024, input_shape=(1, 4, 4), activation="relu"))  # Hidden layer 1
    model.add(ks.layers.Dense(1024, activation="relu"))  # Hidden layer 2
    model.add(ks.layers.Dense(1024, activation="relu"))  # Hidden layer 3
    model.add(ks.layers.Dense(1024, activation="relu"))  # Hidden layer 4
    model.add(ks.layers.Dense(1024, activation="relu"))  # Hidden layer 5
    model.add(ks.layers.Dense(1024, activation="relu"))  # Hidden layer 6
    model.add(ks.layers.Dense(1024, activation="relu"))  # Hidden layer 7
